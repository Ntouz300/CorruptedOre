...
import net.Ntouz.corruptedore.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.PURE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 1, false, false),
                                    ...
                                    new MobEffectInstance(MobEffects.REGENERATION, 200, 2, false, false),
                                    new MobEffectInstance(MobEffects.NIGHT_VISION, 4000, 1, false, false)))
                    .build();
