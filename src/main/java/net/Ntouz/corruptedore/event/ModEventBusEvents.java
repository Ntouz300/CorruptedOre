...
import net.Ntouz.corruptedore.entity.client.MarrowderModel;
...
public class ModEventBusEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(MarrowderModel.LAYER_LOCATION, MarrowderModel::createBodyLayer);
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.MARROWDER.get(), MarrowderEntity.createAttributes().build());
    }
    ...
    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event) {
        ...
        event.register(ModEntities.MARROWDER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                MarrowderEntity::canSpawn, SpawnPlacementRegisterEvent.Operation.REPLACE);
    }
}
